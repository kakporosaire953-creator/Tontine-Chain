...
async function handleOTPRequest(event) {
    ...
    try {
        ...
        await API.auth.requestOTP(currentEmail);
...
async function handleOTPVerify(event) {
    ...
    try {
        ...
        let result = await API.auth.verifyOTP(currentEmail, code);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (emailForm) emailForm.addEventListener('submit', handleOTPRequest);
